    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else //This will continue questions if the if statement is not needed
            {
                ...
                if (width > 50)//If statements will kick in if user input is above 50
                {
                    Console.WriteLine("Package too heavy to be shipped via Package Express. Have a good day.");
                    Console.ReadLine();
                }
                ...
                if (height > 50)//If statements will kick in if user input is above 50
                {
                    Console.WriteLine("Package too heavy to be shipped via Package Express. Have a good day.");
                    Console.ReadLine();
                }
                ...
                if (length > 50)//If statements will kick in if user input is above 50
                {
                    Console.WriteLine("Package too heavy to be shipped via Package Express. Have a good day.");
                    Console.ReadLine();
                }
